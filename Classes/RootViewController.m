...
@synthesize fetchedResultsController=fetchedResultsController_, 
			...
			cityViewController, navigationController;
...
- (void) updateData {
	...
	NSEntityDescription *entityDesc = [NSEntityDescription entityForName:@"regions" inManagedObjectContext:context];
	...
	if ([results count] == 0) {
		...
		for (NSManagedObject *obj in results) {
			...
			[regionsArray addObject:[obj valueForKey:@"name"]];			
		}
	}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	//cell.textLabel.text = [regionsArray objectAtIndex:indexPath.row];
    // Configure the cell...
