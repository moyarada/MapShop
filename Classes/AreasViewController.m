...
@synthesize fetchedResultsController=fetchedResultsController_, 
			...
			currentCity, navigationController;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	shopsViewController = [[ShopsViewController alloc] initWithNibName:@"ShopsViewController" bundle:[NSBundle mainBundle]];
	shopsViewController.managedObjectContext = self.managedObjectContext;
	shopsViewController.navigationController = navigationController;
...
- (NSFetchedResultsController *)fetchedResultsController {
	...
	[fetchRequest setPredicate:[NSPredicate predicateWithFormat:@"city == %@", currentCity]];
...
- (void)addNewItem {
	...
	addRegionController.item = @"Area";
	addRegionController.parent = currentCity;
